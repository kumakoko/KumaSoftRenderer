...
// 画点
void device_t::device_pixel(int x, int y, uint32_t color) 
{
...
// 绘制线段
void device_t::device_draw_line( int x1, int y1, int x2, int y2, uint32_t c) {
    int x, y, rem = 0;
    if (x1 == x2 && y1 == y2) {
...
{
    uint32_t* framebuffer = this->framebuffer[scanline->y];
